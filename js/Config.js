class Config {	
	...
	static ore_percents ={ coal: .05, iron: .05, gold: .02 };
	static ore_grow_max = { coal: 2, iron: 2, gold: 10 };
	static ore_grow_target = { coal: 1, iron: 1, gold: 1 }
	static ore_min_depth = { coal: 3, /* dirt start */ iron: 10, gold: 20 }
	static ore_max_depth = { coal: 20, iron: 30, gold: 40}
	static ore_values = { coal: 15, dirt: 0, iron: 20, gold: 100, stone: 0};
